				...
				<div class="item col s12 m3 hvr-float-shadow wow fadeInLeft">
					<div class="pack-img">
							...
							<figure class="rel overflow-hd1">
								<a href="#"><img class="img-responsive" src="<?php echo $image;?>" alt="Alluring Rajasthan"></a>
							</figure>
			...
			<div id="owl-demo1" class="owl-carousel">
				...
				<div class="item col s12 m3 hvr-float-shadow wow fadeInLeft">
					<div class="pack-img">
							...
							<figure class="rel overflow-hd1">
								<a href='#'><img class="img-responsive" src="<?php echo $img;?>" alt="Alluring Rajasthan"></a>
							</figure>
...
<footer class="container-fluid" style="background:#343434;padding:40px 15px;">
	...
	<div class="col-md-12" style="padding-top:20px;">
		<div class="col-md-6" style="padding-left:0px;">
			<h5 style="color:#e4e4e4;">&copyright; 2019 A Traveller. All rights reserved.</h5>
		</div>
